...
puts "il y a #{counter} valeurs de 5 caractères sans le caractère @"

puts tableau.sort

counter = 0
tableau.each do |i|
  counter += 1 if i[0]=="@" and /[[:upper:]]/=~ i[1]
end

puts "il y a #{counter} qui commence par le symbole @ et une majuscule"

puts tableau = tableau.sort_by {|x| x.length}

puts tableau.index("@epenser")
